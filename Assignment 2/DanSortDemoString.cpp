...
// populates the queue
    string vectorNumbers[] = {"Alex", "Dan", "Steve", "Joel", "Mary", "Karen",
                              "John", "Fred", "Michelle", "Eve", "Tom", "Brenda", "Peta", "Steve", "Daniel",
                              "Cameron", "Josephus", "Ysobel", "Tim", "Ben", "Anna", "Allan", "Ben"};
    int numValues = sizeof(vectorNumbers)/sizeof(vectorNumbers[0]);
    cout << numValues << endl;
    cout << "This is a demo for DanSort for strings, which is a made up thing."
         << endl << endl;
